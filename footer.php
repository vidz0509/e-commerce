<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-md-3">
            <a href="/e-commerce/">
                <img src="/e-commerce/img/logo-white.png" class="site-logo" />
            </a>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <p class="mb-0"><i class="fa fa-phone-alt text-white mr-3"></i>+1 9510935250</p>
        </div>
    </div>
    <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="col-md-12 px-xl-0">
            <p class="mb-md-0 text-center text-secondary">
                &copy; <a class="text-white" href="/e-commerce/">Brocode Carting</a>. All Rights Reserved. Designed
                by Mr.Vairag Bavadiya
            </p>
        </div>
    </div>
</div>
